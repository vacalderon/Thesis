...
\graphicspath{{./Chapter-1/figs/}{./Chapter-2/figs/}{./Chapter-3/figs/}{./Chapter-4/figs/}{./Chapter-5/figs/}{./Chapter-6/figs/}{./Chapter-7/figs/}}
...
\addtolength{\chapterfootskip}{0.5in}  % A little extra space to ensure there are 2 full double spaced lines
...
\pagestyle{plain}
\newgeometry{margin=1in,lmargin=1.25in,footskip=0.5in, includehead, includefoot}
