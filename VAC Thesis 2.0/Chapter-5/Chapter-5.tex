...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{VAC Thesis 2.0/Chapter-5/figs/All_results_NLTHA_Figure.pdf}
...
\begin{figure}[htbp]
	...
	\label{fig:CDF_strain_vs_ALR}
\end{figure}
\subsubsection{Strain demands $(\varepsilon)$ vs $Sd(T_{eff},\xi)$}
\begin{figure}[htbp]
	\centering
